                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-file-alt"></i> Nuevo Flujo Tramite</h5>
                                    ...
                                    <div class="modal fade" id="editProcessFormModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editProcessFormModalLabel"><i class="fas fa-edit"></i> Editar Flujo
                                                        Tramite
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    ...
                                                    <form id="editProcesForm" method="POST">
                                                        ...
                                                        <div class="form-group row m-b-15">
                                                            <label class="col-md-4 col-sm-4 col-form-label"
                                                                for="fullname">Orden:</label>
                                                            <div class="col-md-8 col-sm-8">
                                                                <select class="form-control" id="orden2"
                                                                    name="orden2" data-parsley-required="true">
                                                                    <option value="0">En espera</option>
                                                                    <option value="1">En proceso</option>
                                                                    <option value="2">Enviado</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group row m-b-0">
                                                            ...
                                                            <div class="col-md-8 col-sm-8">
                                                                <button type="submit"
                                                                    class="btn btn-primary"><i class="far fa-save"></i> Actualizar</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
