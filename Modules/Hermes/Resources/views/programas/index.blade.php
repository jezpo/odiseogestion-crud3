...
--}}
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-heading ui-sortable-handle">
            <h4 class="panel-title">Nueva unidad o Carrera</h4>
        ...
        <div class="panel-body">
            <div class="d-block d-lg-inline-flex">
                <div class="dt-buttons btn-group flex-wrap">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Nueva Carrera o Unidad</button>
                </div>
            </div>
            <hr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Nueva Unidad o carrera</h5>
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                                action="{{ route('programas.create') }}">
                                @csrf
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="fullname">Programa:</label>
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" id="fullname" value="" name="programa" placeholder="programa" data-parsley-required="true">
                                        @error('tramite')
                                ...
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="fullname">Id_padre:</label>
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" id="fullname" value="" name="id_padre" placeholder="id_padre" data-parsley-required="true">
                                        @error('id_padre')
                                            <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                                <li class="parsley-required"> {{ 'Este valor es requerido' }}</li>
                                            </ul>
                                ...
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="fullname">Id_programa:</label>
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" id="fullname" value="" name="id_programa" placeholder="id_padre" data-parsley-required="true">
                                        @error('id_padre')
                                            <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                                <li class="parsley-required"> {{ 'Este valor es requerido' }}</li>
                                            </ul>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <select class="form-control" id="select-required" name="estado" data-parsley-required="true">
                            ...
                            <tbody>
                                @foreach ($programas as $dato)
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td width="10%">{{ $dato->programa }}</td>
                                        <td width="10%">{{ $dato->id_padre }}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('programas.destroy', $dato) }}" method="POST" class="d-inline">
                                                @csrf
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $dato->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Modificar Tipo Tramite</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('programas.update', $dato->id) }}">
                                                            @csrf                                                          
                                                            ...
                                                            <div class="form-group row m-b-15">
                                                                <label class="col-md-4 col-sm-4 col-form-label" for="fullname">Id_padre:</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    <input class="form-control" type="text" id="fullname" value="{{$dato->programa}}" name="id_padre" placeholder="id_padre" data-parsley-required="true">
                                                                    @error('id_padre')
                                                                        <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                                                            <li class="parsley-required"> {{ 'Este valor es requerido' }}</li>
                                                                        </ul>
